odoo.define('odoo_branding.title', function(require) {
    ...
    init: function(parent) {
        ...
        var self = this;
        new Model("website.config.settings").call("search_read",[[], ['company_name']]).then(function (res) {
    ...
    CrashManager.include({
        show_warning: function(error) {
            ...
            var company_name = '';
            new Model("website").call("search_read",[[], ['company_name']], {limit:1}).then(
            function(result){
            company_name = result[0].company_name;
             new Dialog(this, {
                size: 'medium',
                title: company_name || _t("Warning"),
