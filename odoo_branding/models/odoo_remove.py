...
class OdooBrand(models.Model):
    ...
    social_pintrest = fields.Char("Pintest Account")
...
class WebsiteConfig(models.TransientModel):
    ...
    social_pintrest = fields.Char(related='website_id.social_pintrest', string="Pintrest Account")
