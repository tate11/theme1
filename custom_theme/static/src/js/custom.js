...
var _t = core._t;
		...
		$(".clear-all-wishlist").click(function(){
			ajax.jsonRpc('/removeall_wishlist_product', 'call', {}).then(function(data){
				location.reload();
				$(".product").css("display","none");
				$(".product").next('hr').css("display","none");
				$(".wish_count").css("display","none !important");
				$(".clear-all-wishlist").css("display","none");
			});
		});
